return {
	voidstalker_zonespawn = {
		...
		maxslope = 12,
		maxwaterdepth = 0,
		objectname = "Voidstalkers/voidstalker_gate.s3o",
		script = "Voidstalkers/voidstalker_zonespawn.lua",
		seismicsignature = 0,
